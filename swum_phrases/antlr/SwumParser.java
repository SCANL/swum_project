...
public class SwumParser extends Parser {
	...
	public static final int
		RULE_swum_phrase = 0, RULE_noun_phrase = 1, RULE_prepositional_phrase = 2, 
		RULE_verb_group = 3, RULE_verb_phrase = 4;
	private static String[] makeRuleNames() {
		return new String[] {
			"swum_phrase", "noun_phrase", "prepositional_phrase", "verb_group", "verb_phrase"
		};
	}
	...
	public static class Swum_phraseContext extends ParserRuleContext {
		...
		public Swum_phraseContext(ParserRuleContext parent, int invokingState) {
			super(parent, invokingState);
		}
		@Override public int getRuleIndex() { return RULE_swum_phrase; }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof SwumParserListener ) ((SwumParserListener)listener).enterSwum_phrase(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof SwumParserListener ) ((SwumParserListener)listener).exitSwum_phrase(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof SwumParserVisitor ) return ((SwumParserVisitor<? extends T>)visitor).visitSwum_phrase(this);
			else return visitor.visitChildren(this);
		}
	}

	public final Swum_phraseContext swum_phrase() throws RecognitionException {
		Swum_phraseContext _localctx = new Swum_phraseContext(_ctx, getState());
		enterRule(_localctx, 0, RULE_swum_phrase);
		try {
			setState(14);
	...
	public static class Noun_phraseContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof SwumParserListener ) ((SwumParserListener)listener).enterNoun_phrase(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof SwumParserListener ) ((SwumParserListener)listener).exitNoun_phrase(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof SwumParserVisitor ) return ((SwumParserVisitor<? extends T>)visitor).visitNoun_phrase(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class Prepositional_phraseContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof SwumParserListener ) ((SwumParserListener)listener).enterPrepositional_phrase(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof SwumParserListener ) ((SwumParserListener)listener).exitPrepositional_phrase(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof SwumParserVisitor ) return ((SwumParserVisitor<? extends T>)visitor).visitPrepositional_phrase(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class Verb_groupContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof SwumParserListener ) ((SwumParserListener)listener).enterVerb_group(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof SwumParserListener ) ((SwumParserListener)listener).exitVerb_group(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof SwumParserVisitor ) return ((SwumParserVisitor<? extends T>)visitor).visitVerb_group(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class Verb_phraseContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof SwumParserListener ) ((SwumParserListener)listener).enterVerb_phrase(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof SwumParserListener ) ((SwumParserListener)listener).exitVerb_phrase(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof SwumParserVisitor ) return ((SwumParserVisitor<? extends T>)visitor).visitVerb_phrase(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static final String _serializedATN =
		...
		"\2\2\20\r\3\2\2\2\20\16\3\2\2\2\20\17\3\2\2\2\21\3\3\2\2\2\22\24\7\4\2"+
		"\2\23\22\3\2\2\2\24\27\3\2\2\2\25\23\3\2\2\2\25\26\3\2\2\2\26\30\3\2\2"+
		"\2\27\25\3\2\2\2\30\31\7\5\2\2\31\5\3\2\2\2\32\33\7\r\2\2\33\34\5\4\3"+
		"\2\34\7\3\2\2\2\35\37\7\6\2\2\36\35\3\2\2\2\37\"\3\2\2\2 \36\3\2\2\2 "+
		"!\3\2\2\2!$\3\2\2\2\" \3\2\2\2#%\7\b\2\2$#\3\2\2\2%&\3\2\2\2&$\3\2\2\2"+
		"&\'\3\2\2\2\')\3\2\2\2(*\7\7\2\2)(\3\2\2\2)*\3\2\2\2*\t\3\2\2\2+,\5\b"+
